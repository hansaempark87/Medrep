...
[응답형식]
{"name":"이름","hospital":"병원","department":"진료과","position":"직위","tags":["전문분야1","전문분야2"],"schedule":{"mon":{"am":"외래","pm":"-"},"tue":{"am":"-","pm":"외래"},"wed":{"am":"외래","pm":"-"},"thu":{"am":"-","pm":"-"},"fri":{"am":"외래","pm":"-"},"visitTip":"방문 추천 시간과 이유"},"philosophy":"치료 철학 한 문장","preferences":[{"condition":"주요 질환","approach":"선호하는 치료 접근법"}],"publications":[{"title":"논문 제목","journal":"저널명","year":"2024"}],"strategy":{"summary":"영업 전략 핵심 한 문장","actions":[{"icon":"clock","title":"방문","text":"추천 방문 전략"},{"icon":"comment","title":"화제","text":"대화 주제 추천"},{"icon":"file","title":"자료","text":"준비할 자료"}],"do":["해야 할 것","해야 할 것"],"dont":["하지 말아야 할 것","하지 말아야 할 것"]}}`
